	...
	$modificar_reparacion = $_POST["id_reparacion"];
	
	$_SESSION["viaje_a_modificar"] = $modificar_reparacion;
	...
	mysql_select_db ("tpFinal",$conexion) or die ("no db");
		...
		echo "<form class='chequeado' method='post' action=". $validar_modificacion_reparacion2">";
